 ...
 */
@Component
public class ProjectReportTaskSaleExecuter implements ProjectTaskExecuter {

    private static final Log log = LogFactory.getFactory().getInstance(ProjectReportTaskSaleExecuter.class);
