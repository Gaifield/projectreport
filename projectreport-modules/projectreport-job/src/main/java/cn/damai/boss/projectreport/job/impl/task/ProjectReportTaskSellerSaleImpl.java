 ...
 */
@Component
public class ProjectReportTaskSellerSaleImpl implements ProjectReportTask {

	private static final Log log = LogFactory.getFactory().getInstance(
			ProjectReportTaskSellerSaleImpl.class);
	private String taskName = "渠道销售统计任务";
	...
	public void performProjectReportTask(long projectId) {
		...
		projectTaskVo.setTaskType(ProjectTaskTypeEnum.SellerSaleStat.getCode());
		try {
