 ...
 */
@Component
public class ProjectReportTaskSeatStatImpl implements ProjectReportTask {

	private static final Log log = LogFactory.getFactory().getInstance(
			ProjectReportTaskSeatStatImpl.class);
	private String taskName = "项目座位统计任务";
	...
	public void performProjectReportTask(long projectId) {
		...
		projectTaskVo.setTaskType(ProjectTaskTypeEnum.SeatStat.getCode());
		try {
