 ...
 */
@Component
public class ProjectReportTaskReserveStatImpl implements ProjectReportTask {

	private static final Log log = LogFactory.getFactory().getInstance(
			ProjectReportTaskReserveStatImpl.class);
	private String taskName = "项目预留统计任务";
	...
	public void performProjectReportTask(long projectId) {
		...
		projectTaskVo.setTaskType(ProjectTaskTypeEnum.ReserveStat.getCode());
		try {
